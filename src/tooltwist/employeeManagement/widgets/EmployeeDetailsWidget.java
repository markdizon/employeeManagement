...
import tooltwist.employeeManagement.productionHelpers.EmployeeDetailsProductionHelper;
 ...
 * employeeDetails
 */
public class EmployeeDetailsWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "employeeDetails_preview.html";
	private static final String SNIPPET_DESIGN = "employeeDetails_design.html";
	private static final String SNIPPET_PRODUCTION = "employeeDetails_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "employeeDetails_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "employeeDetails_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, EmployeeDetailsProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(EmployeeDetailsProductionHelper.class.getName()));
			}
		}
...
//		String myNavpoint = instance.getProperty("myNavpoint", null);
		String targetPage = instance.getProperty("targetPage", null);
		SnippetParam[] params = {
