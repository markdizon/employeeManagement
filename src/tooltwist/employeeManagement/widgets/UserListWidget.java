...
import tooltwist.employeeManagement.productionHelpers.UserListProductionHelper;
 ...
 * userList
 */
public class UserListWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "userList_preview.html";
	private static final String SNIPPET_DESIGN = "userList_design.html";
	private static final String SNIPPET_PRODUCTION = "userList_production.jsp";
	...
	protected void init(WbdWidget instance) throws WbdException
	{
		...
		instance.defineProperty(new WbdNavPointProperty("target", null, "Target Page", ""));
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "userList_cssHeader.css"),
			};
...
//				// Link to an external stylesheet
					new StylesheetLinkInserter("http://netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap.min.css"),
				// Include a javascript snippet 
				new JavascriptCodeInserter(generator, instance, "userList_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, UserListProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(UserListProductionHelper.class.getName()));
			}
		}
	...
	private SnippetParam[] getSnippetParams(WbdGenerator generator, WbdWidget instance, UimData ud) throws WbdException {
		...
		String targetPage = instance.getProperty("target", null);
		SnippetParam[] params = {
			new SnippetParam("targetPage", targetPage)
		};
		return params;
	}
}
